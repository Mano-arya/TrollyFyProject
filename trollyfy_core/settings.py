...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'testserver', 'trollyfyproject-866789048793.europe-west1.run.app/']
CSRF_TRUSTED_ORIGINS = ['http://127.0.0.1', 'http://localhost', 'https://trollyfyproject-866789048793.europe-west1.run.app']
